module.exports =
  '''
        ...
        <p><cite>‘Science Gossip’</cite> is born from a collaboration between an Arts and Humanities Research Council project in the UK, called <cite>‘Constructing Scientific Communities: Citizen Science in the 19th and 21st Centuries’</cite> (<a href="http://conscicom.org">ConSciCom</a>) and the <cite>Missouri Botanical Garden</cite> who are providing content from the <a href="http://biodiversitylibrary.org/">Biodiversity Heritage Library</a> (BHL).</p> 
      
        <p>BHL is currently engaged in several citizen science initiatives that help leverage the crowd in improving access to its content.  Projects include:  <cite>Art of Life</cite>, where the public helps in describing natural history images; <cite>Purposeful Gaming and BHL</cite> where players engage in online games to help with text correction; <cite>Mining Biodiversity</cite> where annotators help train mining algorithms for named entities, such as taxa, places, habitats and traits; and the <cite>Field Book Project</cite> where “volunpeers” transcribe hand-written field book content.  More information about these projects can be found in the BHL blog post on <a href="http://blog.biodiversitylibrary.org/2014/11/crowdsourcing-and-bhl-current-projects.html">Crowdsourcing and BHL</a></p>
        ...
        <p><cite>‘Science Gossip’</cite> is funded by the <a href="http://www.ahrc.ac.uk/">Arts and Humanities Research Council</a> (Science in Culture theme), as part of <a href="http://conscicom.org/">Constructing Scientific Communities.</a></p>
